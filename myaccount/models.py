...
class Notification(models.Model):
    ...
    send_payment = models.BooleanField(verbose_name='Send Payment',
                                       default=True)
    ...
    info_update = models.BooleanField(verbose_name='information Update',
                                      default=True)
...
class Balance(models.Model):
    ...
    available_balance = models.DecimalField(
        verbose_name='Available Balance', max_digits=19, decimal_places=2,
        default=0.00)
    pending_balance = models.DecimalField(verbose_name='Pending Balance',
                                          default=0.00, max_digits=19,
                                          decimal_places=2,
                                          blank=True)
...
class Card(models.Model):
    ...
    card_type = models.CharField(
        verbose_name='Card Type', max_length=2, choices=CARD_TYPE_CHOICES,
        default=MASTERCARD)
    security_code = models.IntegerField(verbose_name='Security Code')
    billing_address = models.ForeignKey(
        Address, verbose_name='Billing Address', on_delete=models.PROTECT)

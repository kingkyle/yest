...
class SentPayment(models.Model):
    receiver = models.ForeignKey(MyUser, on_delete=models.CASCADE, verbose_name='To', related_name='s_receiver')
    ...
    info = models.CharField(max_length=1000,null=True, default='No Payment Info', verbose_name='Payment Details')
    fee = models.DecimalField( max_digits=19, decimal_places=2, verbose_name='Transaction Fee', default=0.00 )
    sender = models.ForeignKey(MyUser, on_delete=models.CASCADE, verbose_name='From', related_name='s_sender')
...
class ReceivedPayment(models.Model):
    receiver = models.ForeignKey(MyUser, on_delete=models.CASCADE, verbose_name='TO', related_name='r_receiver')
    amount = models.DecimalField(max_digits=19, decimal_places=2)
    ...
    info = models.CharField(max_length=1000, null=True, default='No Payment Info', verbose_name='Payment Details')
    fee = models.DecimalField(max_digits=19, decimal_places=2, verbose_name='Transaction Fee', default=0.00)
    sender = models.ForeignKey(MyUser, on_delete=models.CASCADE, verbose_name='From', related_name='r_sender')
